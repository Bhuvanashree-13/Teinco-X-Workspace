    ...
    <div className="mx-auto w-full max-w-7xl space-y-6">
      ...
      <fieldset disabled={saving || !!error} className="grid min-w-0 items-start gap-6 xl:grid-cols-2">
        ...
        <div className="brand-card p-6 dark:border-gray-700 dark:bg-gray-800">
          ...
          <p className="text-sm leading-6 text-slate-600 dark:text-slate-300">Vyom uses the Gemini API to select verified workspace facts. Configure the connection on the computer or server running this application.</p>
          <dl className="mt-4 space-y-4 text-sm">
            <div><dt className="font-medium">Server environment variables</dt><dd className="mt-2 break-all rounded-lg bg-slate-50 p-3 font-mono text-xs leading-6 dark:bg-gray-900">GEMINI_API_KEY<br />VYOM_GEMINI_MODEL (optional)</dd></div>
