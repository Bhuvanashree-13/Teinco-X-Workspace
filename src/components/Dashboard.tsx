...
interface DashboardData {
  ...
  activeProjects: Array<{ id: number; name: string; code: string; color: string; logoDataUrl?: string | null; _count: { workItems: number }; workItems: Array<{ id: number; key: string; summary: string; status: string; assignee?: { name: string } }> }>
}
