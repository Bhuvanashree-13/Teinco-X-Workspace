...
const signin = { primary: '#315CF3', ink: '#101828', muted: '#667085', subtle: '#667085', background: '#F3F6FF', surface: '#FFFFFF', surfaceRaised: '#FFFFFF', border: '#DCE4FA', danger: '#C73548' }
